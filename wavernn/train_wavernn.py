...
from utils.display import stream, simple_table,num_params_count
...
def main():
    ...
    parser.add_argument('--gta', '-g', default= False, action='store_true', help='train wavernn on GTA features')
    ...
    print("fc3: %.3f million" % (num_params_count(voc_model.fc3)))
    print(voc_model)

    # voc_load_path = './checkpoints/biaobei_mol.wavernn/latest_weights.pyt'
    ...
    total_steps = 1_000_000 if force_train else hp.voc_total_steps
    ...
    for e in range(1, epochs + 1):
        ...
        for i, (x, y, m) in enumerate(train_set, 1):
            ...
            if hp.voc_clip_grad_norm is not None:
                grad_norm = torch.nn.utils.clip_grad_norm_(model.parameters(), hp.voc_clip_grad_norm).cpu()
