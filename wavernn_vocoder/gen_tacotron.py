...
if __name__ == "__main__":
    ...
    # parser = subparsers.add_parser('griffinlim', aliases=['gl'])
    ...
    mel_files_len = len(mel_files)
    for i in range(mel_files_len):
        cur_mel = mel_files[i]
