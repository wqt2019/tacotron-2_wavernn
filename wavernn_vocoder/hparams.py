...
# wav_path = 'I:/dl/LJSpeech-1.1/LJSpeech-1.1/wavs/'
data_path = train_data_base + 'training_data/'
...
voc_test_samples = 100               # How many unseen samples to put aside for testing
...
tts_schedule = [(5,  1e-3, 10_000,  32),   # progressive training schedule
                (2,  1e-4, 50_000,  32),   # (r, lr, step, batch_size)
                (1,  1e-4, 100_000,  16),
                (1,  1e-4, 150_000,  8)]
