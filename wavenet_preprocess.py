...
def main():
	...
	parser.add_argument('--base_dir', default='/xxx/tacotron_2_biaobei/')
	parser.add_argument('--hparams', default='',
		help='Hyperparameter overrides as a comma-separated list of name=value pairs')
	parser.add_argument('--input_dir', default='/xxx/BZNSYP/Wave/')
	parser.add_argument('--output', default='tacotron_output_real_mel/gta/')
