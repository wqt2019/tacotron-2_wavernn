...
def prepare_run(args):
	...
	tmp_path = '/xxx/tacotron_2_biaobei/'
	taco_checkpoint = os.path.join(tmp_path,'logs-' + run_name, 'taco_' + args.checkpoint)

	run_name = args.name or args.wavenet_name or args.model
	wave_checkpoint = os.path.join(tmp_path,'logs-' + run_name, 'wave_' + args.checkpoint)
